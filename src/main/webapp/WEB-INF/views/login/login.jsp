...
<div class="container">
	...
	<h1 style="color: #13471C; text-align:center; font-size: 100; font-style: italic;">PLanet</h1>
		
		<div class="jumbotron" style="padding-top:10px">
		
			<form method="post" action="/login/con" class="form-horizontal">
				<h3 style="text-align:center;" >이메일 로그인</h3>
				...
				<div class="text-center" style="color: #5B9E28;">
				...
				<!-- 비밀번호찾기/회원가입 -->
				<section class="css-hyck8i e5voaya4" style="text-decoration: none;">
					<a class="css-lpbwa0 e5voaya3" href="/user/id/new">아이디 재설정</a>
					<a class="css-lpbwa0 e5voaya3" href="/users/password/new">비밀번호 재설정</a>
					<a class="css-lpbwa0 e5voaya3" href="/normal_users/new">회원가입</a>
				</section>
