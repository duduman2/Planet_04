...
<form action="/join/con" method="post" class="form-horizontal">
	
	<div class="form-group">
		<button type="submit" id="btnJoin" ><a href="/join/con"></a>회원가입</button><br><br><br>
	</div>
...
<!-- 				비밀번호찾기/회원가입 -->
<!-- 				<section class="css-hyck8i e5voaya4" style="text-decoration: none; text-align: center;"> -->
<!-- 					<a class="css-lpbwa0 e5voaya3" href="/user/id/new" style="text-decoration: none;">아이디 재설정</a> -->
<!-- 					<a class="css-lpbwa0 e5voaya3" href="/users/password/new" style="text-decoration: none;">비밀번호 재설정</a> -->
