...
public class Paging {
	...
	private int pageCount; //한 화면에 출력될 푸이지 번호의 개수
	...
	private void makePaging() {
		...
		//기본값 설정
		if(curPage == 0)	setCurPage(1);	//천 페이지를 기본 페이지로 설정한다
		...
		//총 페이지 수 보정
		//	ㄴ 마지막 페이지에 보여질 게시글 수가 listCount보다 작을 때 보여질 1페이지 추가하기
		if(totalPage % listCount > 0 ) totalPage++;
		if(totalPage ==0) totalPage=1;
		
		//총 페이지 수 보정
		//	ㄴ 요청 페이지가 마지막 페이지 번호보다 클 때 마지막 페이지 번호로 고정하기
		...
		//끝 페이지 번호 보정
		//	ㄴ 끝 페이지 번호가 마지막 페이지번호를 넘지 않도록 한다
